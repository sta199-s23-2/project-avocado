...
Because the backward selection model gave us six variables, to choose the top three most prominent factors, we looked at their coeifficients. The three variables with the largest coefficients were: dist_income, which is the median income of the congressional districtin 100K, total_primary, which is the total campaign funds and outside spending in millions, and number of candidates. 

The generated outcomes (reference appendix) tells us that with one unit ($100k) increase in the congressional district's median income, holding other things constant, there is on average a 0.14525 percentage decrease in the candadate's vote share. With one unit (1 million dollar) increase in  the  total campaign funds and outside spending, there is on average a 0.16772 increase in the candidate's vote share. Lastly, everytime there is one more candidate in the same election, there is, on average, a 0.11032 percentage decrease in avergae in the candidate's vote share. 

In short, among all the variables in teh dataset, we have found the three factors with the most explanatory power. We have found that a candidate's performance is positively correlated with total campaign funds and outside spending but negatively correlated with the median income of the congressional district and the number of competing candidates. 
