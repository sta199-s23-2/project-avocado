...
# **Results**
**Using R markdown text to save space, reference appendix for outcomes from running data analysis**
...
We end up choosing the model from the backward selection method because it yielded a lower AIC, indicating that the model is better, and had fewer variables than the best model generated through forward selection. The variables includes in the model are candnumber, quality_cand, qualnumber, openseat, dist_income, total_primary.
