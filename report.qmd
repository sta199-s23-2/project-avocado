...
=======
**Methodology**
>>>>>>> 6a7df9473a01edcf59687ba17de97222213ab331
...
lm1 <- lm(candpct ~ state_abbrev + candnumber + cand_party + quality_cand
          ...
          + total_primary + third + gop + ideo_extreme + former_worker, 
          data = candidate)
stepAIC(lm1,  direction = "backward", na.rm = T) 
```
...
lm2 <- lm(candpct ~ state_abbrev, data = candidate)
